...
def make_sequence(portion: Dict[str, Any], section_id: str) -> List[Dict[str, Any]]:
    ...
    for c in portion_combat:
        ...
        win_target, win_terminal = _normalize_target(c.get("winSection"))
        lose_target, lose_terminal = _normalize_target(c.get("loseSection"))
        escape_target, escape_terminal = _normalize_target(c.get("escapeSection"))
